...
namespace :import do
  ...
  task all: :environment do
    ...
    CSV.foreach('./lib/csv/customers.csv', headers: true, header_converters: :symbol) do |row|
    ...
    CSV.foreach('./lib/csv/invoice_items.csv', headers: true, header_converters: :symbol) do |row|
